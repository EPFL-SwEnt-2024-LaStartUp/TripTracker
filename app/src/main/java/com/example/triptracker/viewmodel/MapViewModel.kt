...
class MapViewModel(
  ...
  //  /**
  //   * This function is used to update all the itineraries in the database with random routes.
  // This is
  //   * temporary code
  //   */
  ...
  //  object PathName {
  //    val pathName =
  //        listOf("EPFL to Vortex", "Lausanne EPFL", "Paris to Eiffel", "NY1", "NY2", "Lac to
  // EPFL")
  //  }
}
