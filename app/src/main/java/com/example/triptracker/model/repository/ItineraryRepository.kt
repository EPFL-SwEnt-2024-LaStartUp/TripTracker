...
/**
 * Repository for the Itinerary class
 * This class is responsible for handling the data operations for the Itinerary class
 * It interacts with the Firebase Firestore to save, update, delete and retrieve the itinerary data$
 */
